 ...
 */
class LoggingThreshold implements ThresholdValue<Long> {
    ...
    String description
    String type
    ValueWatcher<Long> watcher = { ValueHolder<Long> holder ->
        valueHolder = holder
    } as ValueWatcher<Long>
    ...
    public ValueWatcher<Long> watcherForType(String type) {
        return this.type == type ? watcher : null
    }

    @Override
    boolean thresholdWasMet() {
        return getThresholdValue() > maxValue
    }
